    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 space-y-6 max-h-[75vh] overflow-y-auto">
                ...
                <section className="space-y-4">
                    <h3 className="text-sm font-bold text-cyan-500 uppercase tracking-wider flex items-center gap-2"><Zap size={14} /> Configuración de IA</h3>
                    <div className="bg-slate-800/40 p-4 rounded-lg border border-slate-700/50 space-y-4">
                        ...
                        <div>
                            <label className="text-xs text-slate-400 mb-2 block">Enfoque Técnico</label>
                            <div className="flex gap-2">
                                {['Balanced', 'Technique', 'Power'].map(focus => (
                                    <button
                                        ...
                                        className={`flex-1 py-2 rounded-lg text-[10px] font-bold border transition-all uppercase ${tempProfile.trainingPreferences?.techniqueFocus === focus ? 'bg-cyan-600 border-cyan-500 text-white' : 'bg-slate-900 border-slate-700 text-slate-400'}`}
                                    >
