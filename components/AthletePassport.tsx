...
export const AthletePassport: React.FC = () => {
    ...
    return (
        <div className="relative w-full max-w-[320px] mx-auto">
            <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-2 border-yellow-500/40 rounded-[2.5rem] p-6 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-500">
                ...
                <div className="flex justify-between items-start mb-4 relative z-10">
                    ...
                    <div className="p-2.5 bg-yellow-500/10 rounded-2xl border border-yellow-500/20">
                        <Shield size={28} className="text-yellow-500/80" />
                    </div>
                </div>
                ...
                <div className="relative w-28 h-28 mx-auto mb-6">
                    ...
                    <div className="absolute -bottom-1 right-0 bg-yellow-500 text-slate-950 font-black text-[9px] px-2.5 py-1 rounded-lg shadow-xl uppercase">
                ...
                <div className="grid grid-cols-2 gap-y-4 gap-x-6 relative z-10 border-t border-white/5 pt-4">
            ...
            {showInfo && (
                <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-md flex items-center justify-center p-6" onClick={() => setShowInfo(null)}>
                    <div className="bg-slate-900 border border-yellow-500/30 p-8 rounded-[2.5rem] max-w-sm text-center relative" onClick={e => e.stopPropagation()}>
                        ...
                        <button onClick={() => setShowInfo(null)} className="w-full bg-white text-slate-950 font-black py-4 rounded-2xl uppercase tracking-widest text-xs">Entendido</button>
                    </div>
                </div>
            )}
        </div>
