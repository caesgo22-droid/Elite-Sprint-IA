...
export const GeminiLive: React.FC = () => {
  ...
  const [errorType, setErrorType] = useState<'none' | 'billing' | 'quota' | 'generic'>('none');
  ...
  return (
    <div className="h-[calc(100dvh-160px)] flex flex-col items-center justify-center relative bg-slate-950 rounded-3xl overflow-hidden border border-slate-800 shadow-2xl p-6">
      ...
      <div className="z-10 flex flex-col items-center gap-8 w-full max-sm">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-slate-500 mt-1">Inteligencia Nativa Gemini 2.5</p>
        </div>
        ...
        {/* Panel de Advertencia de Cuota Agotada */}
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2 pt-2">
                  <a 
                    ...
                    target="_blank" 
                    className="flex-1 bg-orange-600 text-white text-[10px] font-black uppercase py-2 rounded-lg text-center hover:bg-orange-500 transition-colors"
                  >
                    Ver en AI Studio
                  </a>
                  <button 
                    onClick={handleSelectKey}
                    className="flex-1 bg-slate-800 text-slate-300 text-[10px] font-bold py-2 rounded-lg text-center hover:bg-slate-700 transition-colors"
                  >
                    Cambiar Key
                  </button>
                </div>
        ...
        {/* Panel de Advertencia de Facturación */}
          ...
          <div className="bg-red-900/20 border border-red-500/30 rounded-2xl p-4 w-full animate-in slide-in-from-bottom-2">
            <div className="flex gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[11px] text-slate-400 leading-relaxed">
                  Para usar la Voz Nativa necesitas una clave de un proyecto con facturación activa. Tu cuenta gratuita actual no permite este flujo.
                </p>
                <div className="flex gap-2 pt-2">
                  <button 
                    onClick={handleSelectKey}
                    className="flex-1 bg-red-600 text-white text-[10px] font-black uppercase py-2 rounded-lg flex items-center justify-center gap-1"
                  >
        ...
        <p className="text-[10px] text-slate-600 text-center italic">
          * Para evitar eco, usa siempre auriculares durante la sesión.
        </p>
      </div>
