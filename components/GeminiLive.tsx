        ...
        <div className="z-10 flex flex-col items-center space-y-10 w-full max-w-sm">
            ...
            <div className="text-center space-y-2">
                ...
                <div className="flex items-center gap-2 justify-center">
                    <span className="px-2 py-0.5 bg-slate-800 rounded text-[10px] text-slate-400 font-mono">24kHz</span>
                    <span className="px-2 py-0.5 bg-slate-800 rounded text-[10px] text-slate-400 font-mono">PCM</span>
                    <span className="px-2 py-0.5 bg-slate-800 rounded text-[10px] text-slate-400 font-mono">NATIVE</span>
                </div>
            </div>
            ...
            {!isActive && (
                <div className="bg-slate-900/50 border border-slate-800 p-4 rounded-xl w-full text-center backdrop-blur-sm animate-in fade-in slide-in-from-bottom-2">
                    <p className="text-[10px] text-slate-500 mb-2 font-bold uppercase tracking-widest flex items-center justify-center gap-2"><Zap size={12}/> Capacidades Omni-Conscientes</p>
