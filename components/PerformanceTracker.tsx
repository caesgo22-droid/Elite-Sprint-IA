...
import { Plus, Trash2, Edit2, Save, X, Calculator, Timer, Activity, TrendingUp, Filter, Download, MapPin, AlignLeft, Calendar, Info, BrainCircuit, Zap, Trophy } from 'lucide-react';
  ...
  const handleSave = () => {
    ...
    if (type === 'Competition') {
        ...
        if (timeValue < currentPB) {
            ...
            alert(`🏆 ¡NUEVO PB DETECTADO! Perfil actualizado: ${timeValue.toFixed(2)}s`);
        }
    }
