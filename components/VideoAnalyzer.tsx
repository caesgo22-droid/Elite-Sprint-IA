...
import { Loader2, AlertTriangle, CheckCircle, History, ScanLine, UploadCloud, Play, Download, Share, Zap, Info, ToggleLeft, ToggleRight, Ruler, FileText, Video, GraduationCap, UserCircle2, LocateFixed, Activity } from 'lucide-react';
                ...
                <div className="space-y-6">
                        ...
                        {measuredData && (
                            <div className="hidden md:grid absolute bottom-4 left-4 right-4 grid-cols-5 gap-2 pointer-events-none">
                                <div className="bg-slate-950/80 backdrop-blur p-2 rounded-lg border border-slate-700 pointer-events-auto">
                                    <div className="text-[10px] text-slate-400 font-bold uppercase flex items-center">Rodilla</div>
                                    <div className={`text-sm font-mono font-bold ${measuredData.knee.color}`}>{measuredData.knee.value}</div>
                                </div>
                                <div className="bg-slate-950/80 backdrop-blur p-2 rounded-lg border border-slate-700 pointer-events-auto">
                                    <div className="text-[10px] text-slate-400 font-bold uppercase flex items-center">Cadera</div>
                                ...
                                <div className="bg-purple-900/90 backdrop-blur p-2 rounded-lg border border-purple-500/50 pointer-events-auto">
                                    <div className="text-[10px] text-purple-300 font-bold uppercase flex items-center">Oscilación CoM <InfoButton title="Eficiencia" text="Menos es mejor. Energía vertical desperdiciada."/></div>
                                    <div className="text-sm font-mono font-bold text-white">{advancedMetrics.verticalOscillation || '-'}</div>
                                </div>
                                <div className="bg-slate-900/90 backdrop-blur p-2 rounded-lg border border-cyan-900/50 pointer-events-auto">
                                    <div className="text-[10px] text-cyan-400 font-bold uppercase flex items-center">Zancada</div>
                    ...
                    {measuredData && (
                        <div className="md:hidden grid grid-cols-3 gap-2 animate-in fade-in">
                            ...
                            <div className="bg-slate-900 p-2 rounded-xl border border-slate-700 text-center">
                                <div className="text-[9px] text-slate-400 font-bold uppercase">Cadera</div>
                            ...
                            <div className="col-span-3 grid grid-cols-2 gap-2 mt-1">
                                <div className="bg-purple-900/20 p-2 rounded-xl border border-purple-500/30 flex justify-between items-center px-3">
                                    <div className="text-[9px] text-purple-300 font-bold uppercase flex items-center gap-1"><LocateFixed size={10}/> CoM Bounce</div>
                                    <div className="text-lg font-bold text-white font-mono">{advancedMetrics.verticalOscillation || '-'}</div>
                                </div>
                                <div className="bg-purple-900/20 p-2 rounded-xl border border-purple-500/30 flex justify-between items-center px-3">
                                    <div className="text-[9px] text-purple-300 font-bold uppercase flex items-center gap-1"><Activity size={10}/> Force Idx</div>
